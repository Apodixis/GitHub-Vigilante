...
def graphql_user_partial_query(login) -> str:
    ...
    return f"""
    query userPartialSearch($page_size: Int = {page_size}, $social_size: Int = {social_size}, $cursor: String) {{
...
def graphql_organizations_exact_query(orgLogin: str) -> str:
    ...
    return f"""
    query organizationExactSearch($page_size: Int = {page_size}, $social_size: Int = {social_size}, $members_cursor: String) {{
