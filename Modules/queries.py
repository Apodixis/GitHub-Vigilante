...
def graphql_user_exact_query(login) -> str:
    ...
    return f"""
    query userExactSearch($page_size = {page_size}, $social_size = {social_size}, $following_cursor: String, $followers_cursor: String) {{
...
def graphql_user_partial_query(login) -> str:
    ...
    return f"""
    query userPartialSearch($page_size = {page_size}, $social_size = {social_size}, $cursor: String) {{
...
def graphql_organizations_exact_query(orgLogin: str) -> str:
    ...
    return f"""
    query organizationExactSearch($page_size = {page_size}, $social_size = {social_size}, $members_cursor: String) {{
